...
export async function getServerSideProps({ params }: FeedProps) {
    const queryClient = new QueryClient()

    await queryClient.prefetchQuery({
        queryKey: ['feedentries', parseInt(params.id)],
        queryFn: getFeedEntries,
    })

    await queryClient.prefetchQuery({
        queryKey: ['feedinfo', parseInt(params.id)],
        queryFn: getFeedInfo,
    })
...
export default function Home({ dehydratedState, params }: FeedProps) {
